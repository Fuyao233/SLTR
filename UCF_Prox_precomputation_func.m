...
disp('===== Prox_Remurs =====')
    ...
    for idx_e = 1:length(epsilon_list)
        ...
        tic
        [estimatedW, errSeq, operator_group, ~, mid] = Prox_Remurs(double(trainInvertX), matrixY, cvTau, cvLambda, cvEpsilon, rho, maxIter, minDiff);
        t = toc;

        save(sprintf('UCF101_data_XX/Group%d.mat', num), 'mid');
